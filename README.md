...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-5h1qcpo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-5h1qcpo.containers.anotherwebservice.com/
...
```
git clone git@github.com:SuperDuperNoob/container-5h1qcpo.git
cd container-5h1qcpo
```
...
```
docker attach container-5h1qcpo
```
